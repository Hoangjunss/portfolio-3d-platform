...
- Create: `backend/src/main/java/com/portfolio/platform/controller/AnalyticsController.java`
...
class AnalyticsServiceTest {
    ...
    void track_templateClick_persistsEventAndIncrementsCount() {
        TrackEventForm request = new TrackEventForm("TEMPLATE_CLICK", 7L, "session-1", "Mozilla/5.0", "https://x.com");
...
- [ ] **Step 3: Create `AnalyticsEvent`, `AnalyticsEventRepository`, `TemplateClickCountDto`, `TrackEventForm`, `AnalyticsSummaryDto`**
...
public record TrackEventForm(String eventType, Long templateId, String sessionId, String userAgent, String referrer) {
}
```
...
public class AnalyticsService {
    ...
    @Transactional
    public void track(TrackEventForm request, String rawIp) {
...
public class AnalyticsController {
    ...
    public void track(@RequestBody TrackEventForm request, HttpServletRequest servletRequest) {
